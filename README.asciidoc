...
. https://github.com/javaee-samples/webinars/issues/5[Reza Rahman] on Domain Driven Design - Java 27, 2014
. https://github.com/javaee-samples/webinars/issues/16[Emmanuel Bernard] on HIbernate OGM - ??
